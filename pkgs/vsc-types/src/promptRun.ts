...
export interface PromptRunCompletedPayload {
  runId: string;
  promptId: string;
  timestamp: number;
  success: boolean;
...
export interface PromptRunStartedMessage {
  type: "promptRunStarted";
  payload: PromptRunStartedPayload;
}

export interface PromptRunUpdateMessage {
  type: "promptRunUpdate";
  payload: PromptRunUpdatePayload;
}

export interface PromptRunCompletedMessage {
  type: "promptRunCompleted";
  payload: PromptRunCompletedPayload;
}

export interface PromptRunErrorMessage {
  type: "promptRunError";
  payload: PromptRunErrorPayload;
}

export interface PromptRunResultCompletedMessage {
