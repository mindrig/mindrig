/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings env.d.ts` (hash: 3024b57ae2e2a2201395313388a1e576)
...
declare namespace Cloudflare {
  ...
  interface Env {
    VERCEL_GATEWAY_KEY: string;
    DEMO_GATEWAY_ORIGIN: string;
    MINDRIG_DEV_OFFLINE: string;
    MINDRIG_DEV_RECORD: string;
  }
}
