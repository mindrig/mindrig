...
- [x] [Capture package directories](#capture-package-directories): List all current packages under `./pkgs` and the legacy locations slated for relocation, saving the output to `plans/001-pkg-consolidation/artifacts/inventory.md`.
...
- Append the command outputs to `plans/001-pkg-consolidation/artifacts/inventory.md` under dated headings.
...
- Write structured data to `plans/001-pkg-consolidation/artifacts/inventory-data.json`.
